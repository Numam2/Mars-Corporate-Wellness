...
class AllRoutinesList extends StatelessWidget {
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) => RoutineIntro(
                          ...
                          firstWeek: _routine[index].firstWeek,
                          firstDay: _routine[index].firstDay)));
              },
              child: Container(
                height: 120,
                decoration: BoxDecoration(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: Text(
                              _routine[index].objectives.toString().replaceAll('[', '').replaceAll(']', ''),
                          ...
                          Container(
                            width: MediaQuery.of(context).size.width * 0.45,
                            child: Text(
                              _routine[index].duration + ' - ' + difficulty[_routine[index].userExperience],
