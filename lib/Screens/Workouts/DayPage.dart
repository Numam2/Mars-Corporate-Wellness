...
class _DayDetailState extends State<DayDetail> {
  ...
  /// Classes/Variables within Widget
  Future getSets() async {
    var firestore = Firestore.instance;
    var dayPath = widget.day.reference.path;
    
    QuerySnapshot qn = await firestore.document(dayPath).collection("Workout").getDocuments();
    return qn.documents;
  }
            ...
            return 
              Scaffold(
                    ...
                    appBar: AppBar(
                      ...
                      centerTitle: true,
                      title: Text(widget.day.data["Day"]),
                        // actions: <Widget>[
                        //   Padding(
